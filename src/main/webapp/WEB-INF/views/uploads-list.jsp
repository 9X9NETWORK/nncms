...
<div id="lightbox-edit-video" class="lightbox-content lightbox-upload-video">
<div class="upload-audio">
<div class="upload-audio-wrap">
<a href="#" class="btn-close">Close</a>
<h3><img src="images/text_edit_file.png" alt="Edit File" title="Edit File" /></h3>
<p class="required"><acronym title="Required field" class="mark-required">*</acronym>Required field</p>
<form name="lightboxUploadForm" id="lightboxUploadForm" method="get" action="uploads-list.html">
<div class="fminput">
<label><acronym title="Required field" class="mark-required">*</acronym>File title</label>
...
<span class="notice clear">Better results with 720x480 or higher resolution image.</span>
<span class="notice highlight clear">Please upload jpeg, png, or gif files.</span>
</div>
</div>
<div class="form-btn">
<p class="notice">Please fill in all required fields.</p>
<div class="form-btn-wrap">
<p class="btns btn-cancel"><span><input type="reset" value="Cancel" /></span></p>
<p class="btns btn-save"><span><input type="submit" value="Save" /></span></p>
</div>
...
<div id="lightbox-play-video" class="lightbox-content">
<iframe width="707" height="441" src="http://www.youtube.com/v/dySwrhMQdX4?wmode=transparent&version=3&autoplay=0&controls=0&showinfo=0" frameborder="0"></iframe>
<p class="btns btn-close"><span><a href="#">Close</a></span></p>
</div>
...
<!--============================== content-main start ========================-->
<div id="content-wrap" class="uploads">
...
<h2>My Uploads</h2>
<p class="upload-audio btns"><span><a href="#">Upload audio files</a></span></p>
</div>
...
<a href="#" class="video-edit">Video Edit</a>
<a href="#" class="video-play">Video Play</a>
</p>
<p class="tip-arrow"><img src="images/bubble_arrow.png" alt="" /></p>
<div class="video-tip">
<div class="video-bubble">
<div class="video-bubble-wrap">
<p>Kate Nash Song - Live in Paradiso</p>
<p>From <a href="#" class="site">9x9.tv</a> &amp; <a href="#" class="site">pic.com.tw</a><br />By <a href="#">John</a><br />on 2012-12-08</p>
</div>
</div>
</div>
</li>
...
<p class="more"><span><em><img src="images/icon_load.gif" alt="" /> More</em></span></p>
</div>
</div>
</div>
</div>
