...
function setupLanguageAndRenderPage(user, isStoreLangKey) {
    ...
    nn.api('GET', 'lang/' + lang + '.json', null, function(langPack) {
        ...
        if (true === isStoreLangKey) {
            ...
            $('#title-func .langkey, #header a, #footer a, .lightbox-content .btns a, #studio-nav a, #studio-nav .langkey, #func-nav a, #epcurate-nav .langkey, #epcurateForm .langkey').each(function() {
