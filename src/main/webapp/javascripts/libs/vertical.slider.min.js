...
var sliderHeight=origSliderHeight-handleHeight;var sliderMargin=(origSliderHeight-sliderHeight)*0.5;$(sliderwrap+' .ui-slider').css({height:sliderHeight,'margin-top':sliderMargin});}else{$(sliderwrap+' .slider-vertical').slider();$(sliderwrap).hide();}
$(sliderwrap+' .ui-slider').unbind('click');$(sliderwrap+' .ui-slider').click(function(event){event.stopPropagation();});$(outer+', '+sliderwrap+' .slider-vertical').unbind('mousewheel');$(outer+', '+sliderwrap+' .slider-vertical').mousewheel(function(event,delta){var speed=2;var sliderVal=$(sliderwrap+' .slider-vertical').slider('value');sliderVal+=(delta*speed);$(sliderwrap+' .slider-vertical').slider('value',sliderVal);event.preventDefault();});}